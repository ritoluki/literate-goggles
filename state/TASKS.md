...
| T022 | P4 | Complete cart locking/ledger/recovery | T021 | Core workflow composition; recovery job/status API | 10parallel/2keys/commit crash→1order | FR-08,FR-09 | AT-13 (complete revalidation),AT-15,AT-20,AT-21,AT-22,AT-23,AT-24,AT-25,AT-53 | IN_PROGRESS (reconciliation implemented; process restart/timeout/stock-race evidence pending) |
